RegisterServerEvent('SpawnObject')
AddEventHandler('SpawnObject', function(objectName, x, y, z, heading)
    TriggerClientEvent('ReceiveObject', -1, objectName, x, y, z, heading)
end)
